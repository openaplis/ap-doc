...
templates['partials/ancillary-studies'] = template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "    <div class=\"whiteBox\" style=\"width: 9mm; border: none; text-align: right; font-weight: bold;\">"
    ...
    + ((stack1 = helpers.each.call(alias3,((stack1 = ((stack1 = (depth0 != null ? depth0.specimenOrders : depth0)) != null ? stack1.specimenOrder : stack1)) != null ? stack1.aliquotOrders : stack1),{"name":"each","hash":{},"fn":container.program(2, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
  ...
  return "          <div class=\"whiteBox\" style=\"width: 15mm; border: none; text-align: left; line-height: 1; padding-left: 4.5mm;\">"
...
templates['documents/surgical/page'] = template({"1":function(container,depth0,helpers,partials,data,blockParams,depths) {
  ...
  return ((stack1 = container.invokePartial(partials["partials/header"],depth0,{"name":"partials/header","data":data,"indent":"    ","helpers":helpers,"partials":partials,"decorators":container.decorators})) != null ? stack1 : "")
    ...
    + ((stack1 = container.invokePartial(partials["partials/ancillary-studies"],depth0,{"name":"partials/ancillary-studies","data":data,"indent":"    ","helpers":helpers,"partials":partials,"decorators":container.decorators})) != null ? stack1 : "")
